...
<div class="box_container">
 <div class="wap_pro detail_bx">
    ...
    <div id="show_gala">
      <?php if(!empty($videos_pro)){ ?>
        <div class="tab_gala active" id="tab_gala1">
          ...
          <a class="countimg" data-fo="fotorama_video" data-owl="owl-gala-vd">
            <span class="btn"><i class="fa fa-search-plus" aria-hidden="true"></i> Phóng to tính năng nổi bật</span>
  ...
  <link href="c.css?<?=time()?>" rel="stylesheet" type='text/css' />
  <ul class="product_info">
   ...
   <li>
    <div id="rattings">
      ...
      - <b><?=_luotxem?>:</b> <span><?=$row_detail['luotxem']?></span>
    </div>
  </li>
  <li class="gia">
...
<?php } ?>
<li class="has-quantity">
  <div class="title"><?=_soluong?> </div>
  <div class="controller">
    <button class="increment">-</button>
    <input type="text" value="1" disabled class="soluong" /> 
    <button>+</button>
  </div>
  <div class="return">1000 sản phẩm còn lại</div>
</li>
<li class="cart-action">
  <a class="add_to_cart cart_popup dathang" data-id="<?=$row_detail['id']?>"><i class="fa fa-cart-plus" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
  <a class="add_to_cart  dathang" data-id="<?=$row_detail['id']?>">Mua ngay</a>
</li>
...
<?php  if($row_detail['thongso'] != '') {?>
  <div class="info-product">
    <div class="title">Thông số kỹ thuật</div>
    <div class="content"><?=$row_detail['thongso']?></div>
  </div>
<?php } ?>
  ...
  <div class="info-product">
    ...
    <div class="content"><?=$row_detail['mota']?></div>
  </div>
<?php } ?>
...
<?php if(!empty($_SESSION['product_viewedz'])){ ?>
