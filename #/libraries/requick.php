<?php
	...
	$idc = (!empty($_REQUEST['idc'])) ? htmlspecialchars($_REQUEST['idc']) : '';
	...
	if(array_key_exists($login_admin, $_SESSION) && (isset($_SESSION[$login_admin]['active']) || $_SESSION[$login_admin]['active'] == true))
	{
		...
		{
			//	session_destroy();
			if(!in_array($_GET['act'],array("login"))){
