            ...
            <table class="table table-hover">
                <thead>
                    <tr>
						...
						<?php } ?>
                        <?php if(isset($config['product'][$type]['show_images2_list']) && $config['product'][$type]['show_images2_list'] == true) { ?>
                            <th class="align-middle">Hình 2</th>
                        <?php } ?>
                        <?php if(isset($config['product'][$type]['show_images3_list']) && $config['product'][$type]['show_images3_list'] == true) { ?>
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <?php if(isset($config['product'][$type]['show_images2_list']) && $config['product'][$type]['show_images2_list'] == true) { ?>
                                    <td class="align-middle">
                                        <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['product'][$type]['thumb2_list']?>/<?=UPLOAD_PRODUCT_L.$items[$i]['photo2']?>" alt="<?=$items[$i]['tenvi']?>"></a>
                                    </td>
                                <?php } ?>
                                <?php if(isset($config['product'][$type]['show_images3_list']) && $config['product'][$type]['show_images3_list'] == true) { ?>
                                    <td class="align-middle">
                                        <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['product'][$type]['thumb3_list']?>/<?=UPLOAD_PRODUCT_L.$items[$i]['photo3']?>" alt="<?=$items[$i]['tenvi']?>"></a>
                                    </td>
                                <?php } ?>
                                <td class="align-middle">
