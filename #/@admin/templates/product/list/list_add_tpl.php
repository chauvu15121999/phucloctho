<?php
    ...
    if(
        ...
        (isset($config['product'][$type]['images2_list']) && $config['product'][$type]['images2_list'] == true) || 
        (isset($config['product'][$type]['images3_list']) && $config['product'][$type]['images3_list'] == true)
    )
    {
        $colLeft = "col-xl-8";
        $colRight = "col-xl-4";
    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="row">
                                    ...
                                    <?php foreach($config['website']['lang'] as $k => $v) { ?>
                                        <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control for-seo" name="data[ten<?=$k?>]" id="ten<?=$k?>" placeholder="Tiêu đề (<?=$k?>)" value="<?=@$item['ten'.$k]?>" required>
                                            </div>
            ...
            <div class="<?=$colRight?>">
                    ...
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <?php
                                ...
                                $dimension2 = "Width: ".$config['product'][$type]['width2_list']." px - Height: ".$config['product'][$type]['height2_list']." px (".$config['product'][$type]['img_type_list'].")";
                ...
                <?php if(isset($config['product'][$type]['images3_list']) && $config['product'][$type]['images3_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Hình ảnh 3 <?=$config['product'][$type]['title_main_list']?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <?php
                                $photoDetail3 = UPLOAD_PRODUCT.@$item['photo3'];
                                $dimension3 = "Width: ".$config['product'][$type]['width3_list']." px - Height: ".$config['product'][$type]['height3_list']." px (".$config['product'][$type]['img_type_list'].")";
