			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if(isset($config['setting']['fanpage']) && $config['setting']['fanpage'] == true) { ?>
						...
						<div class="form-group col-md-4 col-sm-6">
							<label for="fanpage">Youtube:</label>
							<input type="text" class="form-control" name="data[options][youtube]" id="youtube" placeholder="Youtube" value="<?=$options['youtube']?>">
						</div>
						<div class="form-group col-md-4 col-sm-6">
							<label for="fanpage">Instagram:</label>
							<input type="text" class="form-control" name="data[options][ins]" id="ins" placeholder="Instagram" value="<?=$options['ins']?>">
						</div>
						<div class="form-group col-md-4 col-sm-6">
							<label for="fanpage">Twitter:</label>
							<input type="text" class="form-control" name="data[options][tw]" id="tw" placeholder="Twitter" value="<?=$options['tw']?>">
						</div>
					<?php } ?>
