    ...
    <form class="form-user validation-user"  method="post"  enctype="multipart/form-data">
        ...
        <div class="input-group input-user">
            <div class="radio-user custom-control custom-radio">
                <input type="radio" id="nam" name="gioitinh" checked class="custom-control-input" value="1" required>
        ...
        <div class="input-group input-user">
            ...
            <input type="text" class="form-control datepicker" id="ngaysinh" name="ngaysinh" placeholder="<?=nhapngaysinh?>" required>
        ...
        <div class="button-user">
            <input type="submit" class="btn btn-dark btn-block" name="dangky" value="<?=dangky?>">
        </div>
    </form>
</div>
</div>