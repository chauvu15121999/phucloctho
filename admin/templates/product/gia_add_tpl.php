<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=product&act=man_gia<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Size sản phẩm</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save_gia<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
            <label>Giá từ</label>
            <div class="formRight">
                <input type="text" name="giatu" title="Nhập giá từ" id="giatu" class="tipS" value="<?=@$item['giatu']?>" />
            </div>
            <div class="clear"></div>
        </div> 
		...
		<div class="formRow">
            <label>Giá đến</label>
            <div class="formRight">
                <input type="text" name="giaden" title="Nhập giá đến" id="giaden" class="tipS" value="<?=@$item['giaden']?>" />
            </div>
            <div class="clear"></div>
        </div> 
        ...
        <div class="formRow">
            <div class="formRight">
                ...
                <a href="index.php?com=product&act=man_gia<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?><?php if($_REQUEST['type']!='') echo'&type='.$_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
            </div>
            <div class="clear"></div>
        </div>
       ...
       <div id="content_lang_<?=$key?>" class="tab_content none">        
