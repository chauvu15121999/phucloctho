...
<!-- Left navigation -->
<ul id="menu" class="nav row">
    <li class="dash" id="menu1"><a class=" active" title="" href="index.php"><span>Trang chủ</span></a></li>
    <li class="categories_li <?php if(($_GET['com']=='product'&&$_GET['type']=='san-pham') || $_GET['com']=='order' || ($_GET['com']=='excel') || ($_GET['com']=='product'&&$_GET['type']=='san-pham')) echo ' activemenu' ?>" id="menu_"><a href="" title="" class="exp"><span>Thương mại điện tử</span><strong></strong></a>
        <ul class="sub">
            ...
            <?php phanquyen_menu('Hình thức thanh toán','payments','get',''); ?>
        </ul>
    </li>
