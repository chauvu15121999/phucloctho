        ...
        <div id="content_lang_<?=$key?>" class="tab_content">	
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <?php if($_REQUEST['type']=='banner') { ?><span class="size_img">Chiều rộng <b>100px</b> Chiều cao: <b>100px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='pupop') { ?><span class="size_img">Chiều rộng <b>800px</b> Chiều cao: <b>auto</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='qc1' || $_REQUEST['type']=='qc4' || $_REQUEST['type']=='qc5') { ?><span class="size_img">Chiều rộng <b>435px</b> Chiều cao: <b>147px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='qc2') { ?><span class="size_img">Chiều rộng <b>345px</b> Chiều cao: <b>86px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='qc3') { ?><span class="size_img">Chiều rộng <b>435px</b> Chiều cao: <b>147px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='qc4z') { ?><span class="size_img">Chiều rộng <b>345px</b> Chiều cao: <b>525px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='logo') { ?><span class="size_img">Chiều rộng <b>100px</b> Chiều cao: <b>100px</b></span><?php } ?>
                </div>
                <div class="clear"></div>
             </div> 
        </div><!-- End content <?=$key?> -->
