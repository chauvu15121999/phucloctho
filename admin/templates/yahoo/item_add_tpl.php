		...
		<div class="widget">
			...
			<div id="info" class="tab_content">
				...
				<?php if($_GET['act']=='edit'){?>
					<div class="formRow hidden">
						...
						<div class="formRight">
							...
							<div class="mt10"><img src="<?=_upload_khac.$item['photo']?>"  width="100px" alt="NO PHOTO" width="100" /></div>
				...
				<div class="formRow hidden">
					...
					<div class="formRight">
						<input type="text" name="yahoo" title="Nhập vùng miền" id="yahoo" class="tipS validate[required]" value="<?=@$item['yahoo']?>" />
					</div>
					<div class="clear"></div>
				</div>
				<div class="formRow">
				...
				<div class="formRow hidden">
					<label>Chức vụ</label>
					<div class="formRight">
						<input type="text" name="skype" title="Nhập chức vụ" id="skype" class="tipS validate[required]" value="<?=@$item['skype']?>" />
					</div>
					<div class="clear"></div>
				</div>
